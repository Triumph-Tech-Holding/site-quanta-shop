...
const categories: LabCategory[] = [
  ...
  },
  {
    ...
    items: [
      { label: 'CLAUDE.md',           desc: 'Contexto técnico permanente: stack, padrões, regras invioláveis.', icon: '🧠', to: '/lab/docs' },
      { label: 'ARCHITECTURE.md',     desc: 'Fluxos, módulos, decisões arquiteturais e estrutura de diretórios.', icon: '🗺️', to: '/lab/docs', badge: 'novo' },
      { label: 'DEPLOY.md',           desc: 'Guia de deploy: env vars, build, checklist e rollback.', icon: '🚀', to: '/lab/docs', badge: 'novo' },
  ...
  },
  {
    ...
    items: [
      { label: 'CHANGELOG.md',       desc: 'Versões e hotfixes em formato Keep a Changelog + SemVer.', icon: '📜', to: '/lab/docs' },
      { label: 'FEATURES.md',        desc: 'Catálogo de 24 features por MVP, público e status.', icon: '📓', to: '/lab/docs' },
      { label: 'DATA_DICTIONARY.md', desc: 'Entidades, campos LGPD, relações e conformidade da API.', icon: '📘', to: '/lab/docs' },
