...
const categories: LabCategory[] = [
  ...
  },
  {
    ...
    desc: 'Stack, módulos, dependências, fluxos e desenho do sistema.',
    items: [
      { label: 'CLAUDE.md',           desc: 'Contexto técnico permanente: stack, padrões, regras invioláveis.', icon: '🧠', to: '/agencia/painel/admin/docs' },
      { label: 'ARCHITECTURE.md',     desc: 'Fluxos, módulos, decisões arquiteturais e estrutura de diretórios.', icon: '🗺️', to: '/agencia/painel/admin/docs', badge: 'novo' },
      { label: 'DEPLOY.md',           desc: 'Guia de deploy: env vars, build, checklist e rollback.', icon: '🚀', to: '/agencia/painel/admin/docs', badge: 'novo' },
  ...
  },
  {
    ...
    desc: 'Flow Standard, matriz E2E e Definition of Done.',
    items: [
      { label: 'Flow Standard',      desc: 'Checklist técnico FLOW DEVELOPMENT SYSTEMS — 5 seções.', icon: '✅', to: '/lab/flow-standard' },
      { label: 'Matriz de Testes E2E', desc: 'Cenários críticos: auth, cashback, saque, LGPD, LAB.', icon: '🧪', to: '/agencia/painel/admin/docs' },
  ...
  },
  {
    ...
    desc: 'CHANGELOG, FEATURES.md, dicionário de dados e versões.',
    items: [
      { label: 'CHANGELOG.md',       desc: 'Versões e hotfixes em formato Keep a Changelog + SemVer.', icon: '📜', to: '/agencia/painel/admin/docs' },
      { label: 'FEATURES.md',        desc: 'Catálogo de 24 features por MVP, público e status.', icon: '📓', to: '/agencia/painel/admin/docs' },
      { label: 'DATA_DICTIONARY.md', desc: 'Entidades, campos LGPD, relações e conformidade da API.', icon: '📘', to: '/agencia/painel/admin/docs' },
      { label: 'features.json',      desc: 'Fonte de verdade do roadmap — consumida pelo LAB e features panel.', icon: '🔖', href: '/docs/features.json', external: true },
    ],
  },
]
