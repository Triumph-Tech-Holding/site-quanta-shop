  ...
  <div class="p-0">
    <div class="general-content">
      <div class="page-content qs-page">
        ...
        <QsPageHeader eyebrow="ADF — Agente de Fidelização" title="Dashboard de Rede e Leads" description="Acompanhe seus leads atribuídos, cliques nos links de indicação e o cashback residual gerado pela sua rede.">
