        ...
        <div class="col-xl-8 col-md-6">
          <div class="tp-blog-more-wrapper d-flex justify-content-md-end">
            <div class="tp-blog-more mb-50 text-md-end">
              <nuxt-link href="/blog" class="tp-btn tp-btn-2 tp-btn-blue">Ver todos os posts
                <SvgRightArrow />
              </nuxt-link>
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="tp-blog-main-slider">
            <Swiper :slidesPerView="3" :spaceBetween="20" :autoplay="{
              delay: 4000,
            }" :navigation="{
              ...
              }" :modules="[Navigation, Pagination, Autoplay]" class="tp-blog-main-slider-active swiper-container">
              <SwiperSlide v-for="(item, i) in blog_items" :key="i" class="tp-blog-item mb-30">
                ...
                <div class="tp-blog-content">
                  ...
                  <div class="tp-blog-btn">
                    <nuxt-link :href="`/blog-details/${item.id}`" class="tp-btn-2 tp-btn-border-2">
                      Ler mais
                      <span>
                        <SvgRightArrow />
                      </span>
...
const blog_items = blogData.sort((a, b) => a.id - b.id).slice(0, 8);
</script>
