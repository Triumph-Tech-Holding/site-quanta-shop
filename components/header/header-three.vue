<template>
  <header>
    <div id="header-sticky"
      :class="`tp-header-area tp-header-style-transparent-white tp-header-transparent tp-header-sticky has-dark-logo tp-header-height ${isSticky ? 'header-sticky' : ''}`">
            ...
            <div class="col-xl-2 col-lg-2 col-6">
              <div class="logo">
                <nuxt-link href="/">
                  ...
                  <img class="logo-dark" src="/img/logo/logo.png" alt="logo">
                </nuxt-link>
              </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-2 col-6">
              <div class="tp-header-action d-flex align-items-center justify-content-end ml-50">
                ...
                <div class="tp-header-action-item d-lg-none">
                  <button @click="utilityStore.handleOpenMobileMenu()" type="button" class="tp-header-action-btn tp-offcanvas-open-btn">
                    <svg-menu-icon />
                  </button>
                </div>
              </div>
