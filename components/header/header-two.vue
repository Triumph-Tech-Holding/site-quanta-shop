            ...
            <div class="col-md-6">
              <div class="tp-header-info d-flex align-items-center">
                <div class="tp-header-info-item">
                  <a href="https://www.facebook.com/quantabank" target="_blank">
                    <span>
                      <svg-facebook />
                    </span>
                  </a>
                  <a href="https://wa.me/message/QFVP2ILERA4LD1" target="_blank">
                    <span>
                      <svg-whatsapp />
                    </span>
                  </a>
                  <a href="https://www.instagram.com/quanta_bank" target="_blank">
                    <span>
                      <svg-instagram />
                    </span>
                  </a>
          ...
          <div class="tp-mega-menu-wrapper p-relative">
            <div class="row align-items-center">
              ...
              <div class="col-xl-4 col-lg-7 col-md-7 col-sm-8 col-6">
                <div class="tp-header-bottom-right pl-30">
                  <div class="tp-header-search-2 d-none d-sm-block">
                    <form @submit.prevent="handleSubmit">
                      <input type="text" placeholder="Buscar produtos, marcas..." v-model="searchText">
                      <button type="submit">
                        <svg-search />
                      </button>
                    </form>
                  </div>
                  <div class="tp-header-action d-flex align-items-center justify-content-end ml-30">
