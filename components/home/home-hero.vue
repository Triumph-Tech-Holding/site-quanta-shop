...
const slides: Slide[] = [
  {
    ...
    subheadline: 'Transforme seus gastos diários em saldo que cresce todo dia. Dinheiro na conta, não pontos.',
    ctaText: 'Começar a Ganhar',
    ctaLink: '/cadastro',
    image: '/images/hero-consumidor.jpg',
    imageAlt: 'Pessoa feliz usando smartphone',
  },
  {
    ...
    image: '/images/hero-lojista.jpg',
    imageAlt: 'Lojista em sua loja',
  },
  {
