<template>
          ...
          <div class="row">
            <div class="col-xxl-12">
                <div class="breadcrumb__content p-relative z-index-1">
                  <h3 class="breadcrumb__title">Fale com a Quanta Shop</h3>
          ...
          <div class="row">
              <div class="col-xl-9 col-lg-8">
                <div class="tp-contact-wrapper">
                    <h3 class="tp-contact-title">Envie sua mensagem</h3>
              ...
              <div class="col-xl-3 col-lg-4">
                <div class="tp-contact-info-wrapper">
                    <div class="tp-contact-info-item d-none">
                      ...
                      <div class="tp-contact-info-content">
                          <p data-info="mail"><a href="mailto:contato@quantabank.com.br">contato@quantabank.com.br</a></p>
                          <p data-info="phone"><a href="tel:+55 (21) 4040-4866">+55 (21) 4040-4866</a></p>
                      </div>
                    </div>
                      ...
                      <div class="tp-contact-info-content">
                          <p>
                            <a href="https://www.google.com/maps/place/New+York,+NY,+USA/@40.6976637,-74.1197638,11z/data=!3m1!4b1!4m6!3m5!1s0x89c24fa5d33f083b:0xc80b8f06e177fe62!8m2!3d40.7127753!4d-74.0059728!16zL20vMDJfMjg2" target="_blank">
                              Rua do Russel 804, 4º andar <br> Glória, Rio de Janeiro - RJ
                            </a>
                          </p>
                      </div>
                    </div>
                    <div class="tp-contact-info-item">
                      ...
                      <div class="tp-contact-info-content">
                          <div class="tp-contact-social-wrapper mt-5">
                            <h4 class="tp-contact-social-title">Nossas redes sociais</h4>

                            <div class="tp-contact-social-icon">
                                <a href="https://facebook.com/quantashop"><i class="fa-brands fa-facebook-f"></i></a>
                                <a href="https://api.whatsapp.com/message/QFVP2ILERA4LD1?autoload=1&app_absent=0"><i class="fa-brands fa-whatsapp"></i></a>
                                <a href="https://www.instagram.com/quanta_bank/?igshid=YmMyMTA2M2Y%3D"><i class="fa-brands fa-instagram"></i></a>
                            </div>
                          </div>
                      </div>
                    </div>
  ...
  <!-- map area start -->
  <section class="tp-map-area pb-120 d-none">
    <div class="container">
        <div class="row">
          <div class="col-xl-12">
