    ...
    <div class="container">
      <div class="row">
        <div class="tp-section-title-wrapper-6 text-center mb-40">
          <span class="tp-section-title-pre-6 text-uppercase">Você pode gostar</span>
          <h3 class="tp-section-title-6 text-uppercase">Produtos relacionados</h3>
        </div>
      </div>
      <div class="row">
...
// related_products
const related_products = product_data.value.filter(
  (p) =>
